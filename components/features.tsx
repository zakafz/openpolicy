      ...
      <div className="py-8">
        <div className="mx-auto w-full">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="col-span-full overflow-hidden rounded-none shadow-none pl-6 pt-6">
              <div className="flex items-center justify-center p-2 bg-accent w-fit border">
                <Layout className="text-primary size-5" />
              </div>
              <h3 className="text-foreground mt-5 text-lg font-semibold">
                Simple & Fast
              </h3>
              <p className="text-muted-foreground mt-3 max-w-xl text-balance pr-6 w-full">
