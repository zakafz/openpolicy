...
export default function MonitorsShell({ stats }: MonitorsShellProps): React.ReactElement {
    const data = [
    ...
    const userChartData = [
        { type: "GitHub", count: stats.users.github, fill: "var(--color-purple-500)" },
    ...
    const documentChartData = [
        { type: "Published", count: stats.documents.published, fill: "var(--color-info)" },
        { type: "Drafts", count: stats.documents.drafts, fill: "var(--color-warning)" },
    ];
